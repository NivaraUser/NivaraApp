        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_States_Countries_CounteryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProfilePiture = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EndUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EndUsers_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AspNetRoleId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CategeoryId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyRolesToModules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyRolesToModules_CompanyRoles_CompanyRoleId",
                        column: x => x.CompanyRoleId,
                        principalTable: "CompanyRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyRolesToModules_Modules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersTaskDocument", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersTaskDocument_UsersTask_UsersTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeesTasks_UsersTask_TaskId",
                        column: x => x.TaskId,
                        principalTable: "UsersTask",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyRolesToModules_CompanyRoleId",
                table: "CompanyRolesToModules",
                column: "CompanyRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyRolesToModules_ModuleId",
                table: "CompanyRolesToModules",
                column: "ModuleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EndUsers_CityId",
                table: "EndUsers",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_States_CounteryId",
                table: "States",
                column: "CounteryId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersTask_EndUsersId",
                table: "UsersTask",
                column: "EndUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersTaskDocument_UsersTaskId",
                table: "UsersTaskDocument",
                column: "UsersTaskId");
        }
