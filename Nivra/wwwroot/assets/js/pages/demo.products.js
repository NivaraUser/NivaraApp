    ...
    $("#products-datatable").DataTable(
        {
            ...
            columns: [{
                ...
                }, checkboxes: { selectRow: !0, selectAllRender: '<div class="custom-control custom-checkbox"><input type="checkbox" class="custom-control-input dt-checkboxes"><label class="custom-control-label">&nbsp;</label></div>' }
            }, {
                    orderable: !0
                },
                { orderable: !0 },
            ...
            { orderable: !0 },
            { orderable: !1 }],
            select: { style: "multi" }, order: [[1, "asc"]],
